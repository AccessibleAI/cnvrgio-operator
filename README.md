...
|`pg_backup.storageSize`|30Gi|
|`pg_backup.enabled`|false|
|`pg_backup.name`|pg-backup|
|`pg_backup.path`|/opt/cnvrg-backups|
|`pg_backup.script_path`|/opt/script|
|`pg_backup.storageClass`|use-default|
|`pg_backup.cronTime`|1 1 * * *|
|`cnvrgApp.replicas`|1|
...
|`cnvrgAppUpgrade.state`|upgrade|
|`cnvrgAppUpgrade.cacheDsName`|app-image-chache|
|`cnvrgAppUpgrade.cnvrgAppName`|cnvrg-app|
|`cnvrgAppUpgrade.image`|-|
|`cnvrgAppUpgrade.cacheImage`|true|
